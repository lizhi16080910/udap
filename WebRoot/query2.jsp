...
<form action="/udap/cdnlogqueryaction.action" method="action">
		 ...
		 <br>
			...
			<tr>
				<td colspan="3">
				统计某个域名在某天中，状态码为404的错误在top10的设备
			</tr>
			...
			<tr>
			<td  colspan="3">
			<input name="cList" type="checkbox" value="machine" checked/>主机
			...
			<input name="cList" type="checkbox" value="cs" />流量
			...
			<tr>
				<td>
					...
					<select name="term5">
						...
						<option value="5" >分组(group by)</option>
						<option value="6">升序-小到大(order by)</option>
						<option value="7" selected>倒序-大到小(order by desc)</option>
					</select></td>
			 ...
			 <tr>
				<td>
					...
					<select name="term4">
						...
						<option value="8" selected>统计条数(count)</option>
						<option value="9">合计(sum)</option>
						<option value="5" selected>分组(group by)</option>
						<option value="6">升序-小到大(order by)</option>
						<option value="7">倒序-大到小(order by desc)</option>
					</select></td>
