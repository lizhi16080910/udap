...
/**
 * @author chenm 错误请求数-天
 */
@Namespace("/")
@Action(value = "cdnlogbadreqcountday", results = { @Result(name = ActionSupport.SUCCESS, type = "json", params = {}) })
public class CdnlogBadreqCountDayAction extends ActionSupport {
	private static final long serialVersionUID = 1L;

	private final Log log = LogFactory.getLog(getClass());

	public static final String INDEX = "cdnlog.badreq.count.day";
