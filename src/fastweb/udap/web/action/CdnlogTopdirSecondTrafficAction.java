 ...
 */
@Namespace("/")
@Action(value = "cdnlogtopdirsecondtraffic", results = { @Result(name = ActionSupport.SUCCESS, type = "json", params = {}) })
public class CdnlogTopdirSecondTrafficAction extends ActionSupport {
	private static final long serialVersionUID = 1L;

	public static final String INDEX = "cdnlog.topdir.second.traffic";
