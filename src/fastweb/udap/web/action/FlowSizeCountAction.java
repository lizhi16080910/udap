 ...
 */
@Namespace("/")
@Action(value = "flowsizecount", results = { @Result(name = ActionSupport.SUCCESS, type = "json", params = {"excludeProperties","message"}),
		   @Result(name = ActionSupport.ERROR, type = "json", params={"includeProperties","message"})})
public class FlowSizeCountAction extends ActionSupport {
	...
	public enum MetricConst {
		...
		FLOW_HIT_COUNT_ONE("flow.hit.count.one"), FLOW_HIT_COUNT_FIVE("flow.hit.count.five"), FLOW_HIT_COUNT_HOUR("flow.hit.count.hour"),/*流量按回源情况统计*/
