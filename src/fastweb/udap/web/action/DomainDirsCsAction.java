...
@Namespace("/")
@Action(value = "domaindirscs", results = {
...
public class DomainDirsCsAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		try {
			...
			try {
				...
				QueryBuilder dirsQuery = QueryBuilders.termsQuery("dir1", dirs
						.split(","));

				BoolQueryBuilder allQuery = QueryBuilders.boolQuery().must(
						timestampQuery).must(domainQuery).must(dirsQuery);
