 ...
 */
@Namespace("/")
@Action(value = "cdnlogtopdirsecondcount", results = { @Result(name = ActionSupport.SUCCESS, type = "json", params = {}) })
public class CdnlogTopdirSecondCountAction extends ActionSupport {
