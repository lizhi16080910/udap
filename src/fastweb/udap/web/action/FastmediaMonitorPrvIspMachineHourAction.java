...
/**
 * 流媒体数据监控(时间戳->省份->运营商->机器名->主机名->平台)详情
 */
@Namespace("/")
@Action(value = "fastmediamonitorprvispmachinehour", results = { @Result(name = ActionSupport.SUCCESS, type = "json", params = { "excludeProperties", "message" }), @Result(name = ActionSupport.ERROR, type = "json", params = { "includeProperties", "message" }) })
public class FastmediaMonitorPrvIspMachineHourAction extends ActionSupport {
	private static final long serialVersionUID = 1L;

	private final Log log = LogFactory.getLog(getClass());

	private Map<String, Map<String, Map<String, Map<String, Map<String, Map<String, Map<String, Long>>>>>>> result = new TreeMap<String, Map<String, Map<String, Map<String, Map<String, Map<String, Map<String, Long>>>>>>>();
	...
	public String execute() throws Exception {
		...
		try {
			...
			AbstractAggregationBuilder timestampKey = AggregationBuilders.terms("timestamp").field("timestamp").subAggregation(prvKey).size(1500);
...
//			StringTerms prvAgge = response.getAggregations().get("prv");
			...
			for(Bucket timestampbucket : timestampAgge.getBuckets()){
				StringTerms prvAgge = timestampbucket.getAggregations().get("prv");
				Map<String, Map<String, Map<String, Map<String, Map<String, Map<String, Long>>>>>> prvmap = new TreeMap<String, Map<String, Map<String, Map<String, Map<String, Map<String, Long>>>>>>();
				...
				for(Bucket prvbucket : prvAgge.getBuckets()){
					...
					prvmap.put(prvbucket.getKey(), ispmap);
				}
				result.put(timestampbucket.getKey(), prvmap);
			}
	...
	public Map<String, Map<String, Map<String, Map<String, Map<String, Map<String, Map<String, Long>>>>>>> getResult() {
		return result;
	}
