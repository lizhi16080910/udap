...
@Namespace("/")
@Action(value = "fiveminutecscountduowan", results = {
...
public class fiveMinuteDomainCsDuoWan extends ActionSupport {
	private static final long serialVersionUID = 1L;

	private final Log log = LogFactory.getLog(getClass());

	public static final String INDEX = "cdnlog.duowan.flowsize";
