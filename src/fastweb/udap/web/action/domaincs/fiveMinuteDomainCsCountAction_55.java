...
@Namespace("/")
@Action(value = "fiveminutecscount55", results = {
...
public class fiveMinuteDomainCsCountAction_55 extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		try {
			...
			if (domain != null && !domain.equals("all")) {
				...
				allQuery = allQuery.must(QueryBuilders.queryString(domain));
	...
	public String[] getIndex(){
		...
		String[] day = ESUtil.getIndicesFromtime(begin,end+DAY,INDEX);
		List<String> list=new ArrayList<String>();

		for (int i = 0; i < day.length; i++)
		{
			list.add(day[i].substring(0,36));
		}

		Set set = new HashSet(list);
		String [] existsIndices = (String [])set.toArray(new String[0]);

		return existsIndices;
	}
